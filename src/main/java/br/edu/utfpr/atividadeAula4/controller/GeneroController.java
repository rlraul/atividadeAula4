...
public class GeneroController {
    ...
    public String save(@Valid Genero genero,
        ...
        attributes.addFlashAttribute("sucesso", "genero salvo com sucesso!");
    ...
    public String delete(@PathVariable Long id, RedirectAttributes attributes) {
        try {
            ...
            attributes.addFlashAttribute("sucesso", "genero removido com sucesso!");
        } catch (Exception e) {
            attributes.addFlashAttribute("erro", "Falha ao remover genero");
        }
        return "redirect:/genero";
    }
}
